...
def is_riaccertamento_top3_eligible(candidate: Candidate) -> bool:
    if is_main_fulltext_collection(candidate.collection):
        return False
    return candidate.collection.endswith("all_4_2") or candidate.collection.endswith("all_1") or candidate.collection.endswith("all_4_1")
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="Router federato generale v25.4 - ultra-micro patch top3 riaccertamento")
    ...
    print("=== ROUTER FEDERATO GENERALE — BASE v25.4 ===")
