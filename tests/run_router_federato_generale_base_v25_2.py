...
def print_final_command_hint() -> None:
    ...
    print(
        'py tests/run_router_federato_generale_base_v25_2.py --persist-dir data/chroma --query-text "fpv" --query-text "impegno di spesa" --query-text "esigibilità della spesa" --query-text "riaccertamento ordinario dei residui" --query-text "cronoprogramma investimento" --query-text "entrate vincolate"'
    )


def main(argv: Optional[Sequence[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="Router federato generale v25.2 - focus DLgs. 118 sotto-intenti specialistici")
    ...
    print("=== ROUTER FEDERATO GENERALE — BASE v25.2 ===")
