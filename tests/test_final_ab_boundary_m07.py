...
def _m07_request() -> dict:
    return {
        "request_id": "req_phase10_m07_001",
        "case_id": "case_phase10_m07_001",
        "trace_id": "trace_phase10_m07_001",
        ...
        "payload": {
            "query_text": "supporto documentale m07",
            "domain_target": "tuel"
        },
...
def test_level_b_cannot_close_m07() -> None:
    ...
    result = adapter.execute(_m07_request(), provider)
...
def test_valid_m07_support_remains_preparatory_only() -> None:
    adapter = FinalABPreRuntimeAdapter()
