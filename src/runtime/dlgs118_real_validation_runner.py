...
@dataclass
class Dlgs118RealValidationArtifacts:
...
class Dlgs118RealValidationRunner:
    def __init__(
        self,
        *,
    ...
    def run(
        self,
        *,
        case_id: str = "case_dlgs118_real",
        query_text: str = "armonizzazione sistemi contabili bilancio enti locali articolo 11",
        trace_id: str = "trace_dlgs118_real",
        search_item_path: Optional[str | Path] = None,
        detail_payload_path: Optional[str | Path] = None,
        requested_output_type: str = "RAC_DRAFT",
    ) -> Dlgs118RealValidationArtifacts:
        fixture_dir = self.default_fixture_dir()
        search_item_path = Path(search_item_path or (fixture_dir / "dlgs118_search_item_real.json"))
        detail_payload_path = Path(detail_payload_path or (fixture_dir / "dlgs118_detail_payload_real.json"))
        ...
        if ingest_result.source_document is None:
            raise RuntimeError("Ingestion D.Lgs. 118/2011 reale fallita: SourceDocument assente")
        ...
        return Dlgs118RealValidationArtifacts(
...
def run_dlgs118_real_validation() -> dict[str, object]:
    ...
    return {
        ...
        "block_codes": artifacts.technical_report.block_codes,
    }
